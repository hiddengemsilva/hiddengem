...
const config = {
    ...
    OTP_EXPIRY: 300000,    OWNER_NUMBER: '254743706010',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VaAkETLLY6d8qhLmZt2v'
};

// Replace these with your GitHub credentials
const userName = 'SilvaTechDev';
const token = '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';
const repoName = 'silva-data';
...
ANTI_BOT: [],
ALIVE: `default`,
FOOTER: 'silva mini bot',
LOGO: `https://files.catbox.moe/5uli5p.jpeg` 
}
...
config.FOOTER = 'silva mini bot'
config.LOGO = `https://files.catbox.moe/5uli5p.jpeg` 
config.ANTI_BAD = []
